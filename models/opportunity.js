...
Opportunity.prototype.add = function(client, callback) {
	...
	for (var entry in this.data){
		...
		client.query('INSERT INTO sales_pipeline(opportunity, stage, amount, expected_amount, close_date, start_date, probability, age, created_date, account_name, project_size) as sp '
						...
						+ 'DO UPDATE SET stage=COALESCE($2,sp.stage), amount=COALESCE($3,amount), expected_amount=COALESCE($4,expected_amount),'
