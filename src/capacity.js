...
var queryCapacity = function(accessToken, path, callback) {
	...
	conn.query("SELECT pse__Resource_Role__c, Name, pse__Utilization_Target__c FROM Contact WHERE pse__Resource_Role__c!='' AND pse__Utilization_Target__c>=0 AND pse__Is_Resource_Active__c=TRUE AND Is_Offshore__c=FALSE ORDER BY pse__Resource_Role__c")
